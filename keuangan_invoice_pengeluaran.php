...
if (isset($_GET['hapus']) && is_numeric($_GET['hapus'])) {
    ...
    $db->bind(':id', $hapus_id);
    $db->execute();
    header('Location: keuangan_invoice_pengeluaran.php?status=' . urlencode($status));
    exit;
}
...
<head>
    ...
    <title>Rekapan Invoice Pengeluaran</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 px-0">
            <div class="sidebar p-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="keuangan_invoice_pengeluaran.php"><i class="fas fa-file-invoice-dollar me-2"></i> Rekapan Invoice Pengeluaran</a></li>
        ...
        <div class="col-md-9 col-lg-10">
            <div class="p-4">
                <h2>Rekapan Invoice Pengeluaran</h2>
                <p class="text-muted">Daftar pengeluaran berdasarkan status invoice (lunas/belum lunas).</p>
                <div class="mb-3">
                    <a href="keuangan_invoice_pengeluaran_print_pdf.php?status=<?= urlencode($status) ?>" target="_blank" class="btn btn-primary"><i class="fas fa-print me-2"></i>Print PDF</a>
                </div>
                ...
                <div class="card">
                    <div class="card-header">Daftar Invoice Pengeluaran</div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="keuangan_invoice_pengeluaran.php?hapus=<?= $p['id'] ?>&status=<?= urlencode($status) ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')"><i class="fas fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
