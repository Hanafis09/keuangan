...
if (isset($_GET['hapus']) && is_numeric($_GET['hapus'])) {
    ...
    if ($db->execute()) {
        ...
        $error = 'Gagal menghapus data pemasukan.';
    }
}
// Proses input pemasukan
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($tanggal && $kategori && $jumlah > 0) {
        $db->query("INSERT INTO pemasukan (tanggal, kategori, keterangan, jumlah, status_invoice, created_by) VALUES (:tanggal, :kategori, :keterangan, :jumlah, :status_invoice, :created_by)");
        ...
        if ($db->execute()) {
            $success = 'Pemasukan berhasil dicatat.';
        } else {
            $error = 'Gagal mencatat pemasukan.';
        }
    } else {
...
<head>
    ...
    <title>Pemasukan Keuangan Klinik</title>
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 px-0">
            <div class="sidebar p-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="keuangan_pemasukan.php"><i class="fas fa-arrow-down me-2"></i> Pemasukan</a></li>
        ...
        <div class="col-md-9 col-lg-10">
            <div class="p-4">
                ...
                <p class="text-muted">Catat semua pemasukan klinik, baik dari pasien, BPJS, maupun sumber lain.</p>
                <?php if ($error): ?><div class="alert alert-danger"><?= $error ?></div><?php endif; ?>
                <?php if ($success): ?><div class="alert alert-success"><?= $success ?></div><?php endif; ?>
                <div class="card mb-4">
                    <div class="card-header">Input Pemasukan</div>
                    <div class="card-body">
                        <form method="POST">
                            <div class="row g-2">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="kategori" class="form-select" required>
                                        ...
                                        <option value="Invoice Perusahaan">Invoice Perusahaan</option>
                ...
                <div class="card">
                    <div class="card-header">Daftar Pemasukan</div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="keuangan_pemasukan.php?hapus=<?= $p['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus data ini?')"><i class="fas fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
